...
@Component({
	selector: 'lw-breadcrumb',
	templateUrl: './breadcrumb.component.html',
	styleUrls: ['./breadcrumb.component.scss'],
	host: { class: 'lw-breadcrumb' },
...
@Directive({
	selector: 'lw-breadcrumb-location',
	host: { class: 'lw-breadcrumb-location' }
})
export class BreadcrumbLocationDirective {}

@Directive({
	selector: 'lw-breadcrumb-dropdown',
	host: { class: 'lw-breadcrumb-dropdown lw-elevation-1' }
})
